...
public nonisolated enum AppShortcutID: Codable, Hashable, Sendable, CodingKeyRepresentable {
  ...
  case toggleLeftSidebar, revealInSidebar, sidebarSearch
  ...
  private var stableKey: String {
    ...
    case .sidebarSearch: "sidebarSearch"
  ...
  public var displayName: String {
    ...
    case .sidebarSearch: "Search Sidebar"
...
public enum AppShortcuts {
  ...
  public static let sidebarSearch = AppShortcut(id: .sidebarSearch, key: "k", modifiers: .command)
  ...
  public static let groups: [AppShortcutGroup] = [
    ...
    AppShortcutGroup(category: .sidebar, shortcuts: [toggleLeftSidebar, revealInSidebar, sidebarSearch]),
    AppShortcutGroup(
      category: .worktrees,
      shortcuts: [
